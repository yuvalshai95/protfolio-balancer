      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            <AssetSearch onAddAsset={handleAddAsset} existingSymbols={existingSymbols} />
            ...
            {hasAssets && (
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    <h2 className="text-xl font-semibold text-gray-900">Your Portfolio Assets</h2>
                    <p className="text-sm text-gray-600">Set target allocations and current values</p>
                  </div>
                </div>
      ...
      <div className="bg-white border-t border-gray-200 mt-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <p className="text-center text-gray-600 text-sm">
            Portfolio Balancer - Professional investment allocation tool for optimal portfolio management
          </p>
        </div>
      </div>
    </div>
