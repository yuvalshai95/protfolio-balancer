...
import { Calculator, Target, Info, AlertTriangle, CheckCircle } from 'lucide-react';
                  ...
                  <CardContent className="p-4">
                    ...
                    <div className="mb-3">
                      ...
                      <input
                        ...
                        onChange={e => handleShareChange(result.symbol, e.target.value)}
                        ...
                        placeholder="0"
                        aria-describedby={hasError ? `error-${result.symbol}` : undefined}
                      />
                      {hasError && (
                        <p
