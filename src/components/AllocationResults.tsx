...
export const AllocationResults: React.FC<AllocationResultsProps> = ({
  ...
  const totalRecommended = results.reduce((sum, result) => sum + result.recommendedInvestment, 0);
  ...
  return (
    <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h2 className="text-xl font-semibold text-gray-900">Investment Recommendations</h2>
          <p className="text-sm text-gray-600">Optimal allocation to achieve your target percentages</p>
        </div>
      </div>
      ...
      <div className="grid gap-4 mb-6">
        {results.map((result) => (
          <div
            key={result.symbol}
            className="p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors duration-150"
          >
            <div className="flex items-center justify-between mb-3">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 truncate max-w-64">{result.name}</p>
                </div>
              </div>
      ...
      <div className="border-t border-gray-200 pt-4">
        ...
        {remainder > 0.01 && (
          <div className="flex justify-between items-center mb-2">
            ...
            <span className="font-semibold text-orange-600">${remainder.toFixed(2)}</span>
          </div>
        )}
          ...
          <div className="flex items-start gap-2">
            ...
            <div>
              ...
              <p className="text-sm text-orange-700">
                ${remainder.toFixed(2)} remains unallocated due to fractional share constraints. 
                Consider adjusting your allocations or keeping this as cash.
              </p>
            </div>
          </div>
        </div>
